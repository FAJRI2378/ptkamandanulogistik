  ...
  const managementTeam = {
    ...
    tier4: [
      { role: "Crewing Staff", name: "Shinta Melati Sudarsono, S.M", tenure: "3 Years Experience", education: "Management - Univ. 17 Agustus 1945", wa: "6281277778888", avatar: bs, quote: " You have to fight through some bad days to earn the best days of your life." },
    ...
    return (
      <>
        ...
        <main className="bg-[#F8FAFC] min-h-screen font-['Plus_Jakarta_Sans'] overflow-x-hidden">
          ...
          {/* ─── HERO HEADER ─── */}
          <header className="relative w-full min-h-[115vh] pt-[180px] md:pt-[200px] flex items-end justify-center overflow-hidden bg-[#0A2540]">
